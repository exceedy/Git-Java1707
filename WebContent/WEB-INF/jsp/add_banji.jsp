		    ...
		    <div class="row">
		        <div class="col-md-2">
		            <div class="list-group">
		                <a href="${pageContext.request.contextPath}/banji?method=pageList" class="list-group-item ">班级管理</a>
		                <a href="${pageContext.request.contextPath}/banji?method=toAddbanji" class="list-group-item active">添加班级</a>
		            </div>
		        </div>
		        <div class="col-md-10">
